...
def create_freq_reduce(tf_list) -> dict:
    """
...
def generate_wc(tf_dict) -> WordCloud:
    """
...
def generate_wf_hist(tf_dict, n=50):
    """
    Function to generate a plot having table frequency in a dictionary. It returns a plot displaying the word frequency
    for the n words passed as second argument. By default plot is generated with 50 words. B
    :param tf_dict:table frequency dictionary, it can be generated by create_freq_reduce function on this module.
    :param n: Number of words to show in histogram
    :return:
    """
